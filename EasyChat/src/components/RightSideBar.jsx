  ...
  return selectedUser && (
    ...
    ${selectedUser ? "max-md:hidden" : ""}`}>
        ...
        mx-auto">
            ...
            <h1 className="px-10 text-xl flex font-medium mx-auto items-center gap-2">
                {onlineUsers.includes(authUser._id) && <p className="w-2 h-2 rounded-full bg-green-500"></p>}
                {authUser.fullName}
            </h1>
            <p className="px-9 mx-auto">{authUser.bio}</p>
        </div>
